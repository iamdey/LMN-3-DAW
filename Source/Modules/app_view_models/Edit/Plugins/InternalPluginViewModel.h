...
class InternalPluginViewModel : public juce::ValueTree::Listener,
  ...
  public:
    ...
    virtual double getParameterValue(int) { return -1; }
    virtual void setParameterValue(int, double) {}
    virtual juce::Range<double> getParameterRange(int) {
        return juce::Range<double>(0.0, 1.0);
    }
    virtual double getParameterInterval(int) { return .01; }
