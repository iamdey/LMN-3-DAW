...
void ChorusPluginViewModel::setParameterValue(int index, double value) {
    switch (index) {
    case 0:
        chorusPlugin->depthMs.setValue(static_cast<float>(value), nullptr);
        break;
    case 1:
        chorusPlugin->speedHz.setValue(static_cast<float>(value), nullptr);
        break;
    case 2:
        chorusPlugin->width.setValue(static_cast<float>(value), nullptr);
        break;
    case 3:
        chorusPlugin->mixProportion.setValue(static_cast<float>(value), nullptr);
        break;
    default:
        break;
    }
